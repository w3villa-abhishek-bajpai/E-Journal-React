...
function Products() {
  var settings = {
    dots: true,
    infinite: true, // Set infinite to true for smooth looping
    speed: 500,
  ...
  return (
    <div className="w-full bg-gray-100 h-[550px] flex justify-center mt-[0px] overflow-hidden">
      <div className="max-w-screen-xl w-full pt-2">
        <Slider {...settings}>
          {/* First Product */}
          <div className="p-4 border-1 border-slate-300 bg-white max-w-[95%]">
            <div className="w-full h-[250px] overflow-hidden">
              <img src={img} alt="TV" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="p-4 border-1 border-slate-300 bg-white max-w-[95%]">
            <div className="w-full h-[250px] overflow-hidden">
              <img src={images} alt="Canon Camera" className="w-full h-full object-cover" />
            </div>
            <div className="flex justify-between items-center w-full bg-gray-300 h-[40px] mt-2 px-2">
          ...
          <div className="p-4 border-1 border-slate-300 bg-white max-w-[95%]">
            <div className="w-full h-[250px] overflow-hidden">
              <img src={image} alt="Headphones" className="w-full h-full object-cover" />
            </div>
            <div className="flex justify-between items-center w-full bg-gray-300 h-[40px] mt-2 px-2">
              <div className="a1"><a href="s">Headphones</a></div>
              <div className="a2"><p>Model Y200</p></div>
            </div>
            <div>
              <p className="mt-[1px] px-2">Wireless Headphones</p>
              <div className="mt-[1px] px-2"><span>$199.99</span></div>
              <div className="flex justify-between mt-1 px-2">
                <div className="flex w-[40%] justify-between">
                  <div className="flex h-[30px] justify-center items-center">1</div>
                  <div className='h-[30px]'>
          ...
          <div className="p-4 border-1 border-slate-300 bg-white max-w-[95%]">
            <div className="w-full h-[250px] overflow-hidden">
              <img src={imag} alt="Shoes" className="w-full h-full object-cover" />
            </div>
            <div className="flex justify-between items-center w-full bg-gray-300 h-[40px] mt-2 px-2">
              <div className="a1"><a href="s">Nike Shoes</a></div>
              <div className="a2"><p>Model Z400</p></div>
            </div>
            <div>
              <p className="mt-[1px] px-2">Sport Shoes</p>
              <div className="mt-[1px] px-2"><span>$125.00</span></div>
              <div className="flex justify-between mt-1 px-2">
                <div className="flex w-[40%] justify-between">
                  <div className="flex h-[30px] justify-center items-center">1</div>
                  <div className='h-[30px]'>
