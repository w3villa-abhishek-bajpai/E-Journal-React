    ...
    <div className="w-full bg-gray-100 pt-8 ">
      <div className="max-w-screen-xl w-full mx-auto ">
        ...
        <div className="w-full  flex justify-center items-center pt-6  ">
          <div className="w-[90%] sm:w-[80%] md:w-[60%] flex flex-wrap justify-center">
            {/* Category Item: Featured */}
            <div className="w-[48%] sm:w-[23%] md:w-[23%] h-[50px] bg-blue-700 flex justify-center items-center sm:mb-0">
              <p className="text-white font-bold text-xs sm:text-base">FEATURED</p>
            </div>
            {/* Category Item: Latest */}
            <div className="w-[48%] sm:w-[23%] md:w-[23%] h-[50px] bg-gray-300 flex justify-center items-center  sm:mb-0">
