...
function BlogCr() {
  ...
  return (
    <>
        <div className="w-full bg-gray-100 h-[750px] flex justify-evenly  ">
        <div className="max-w-screen-xl w-full  h-[730px] ">

    
          <div className="slider-container w-full  py-10  h-[630px] text-[14px] sm:ml-[15px]">
            <Slider {...settings}>
              <div className='border-2 border-gray-300 relative h-[100%] max-w-[90%]  ml-5 md:ml-0'>
                <div className='h-[50%] w-full '>
                <img src={G1} alt=""  className=' h-[100%] w-full object-fill object-center ' />
                </div>
              ...
              <div className='border-2 border-gray-300 relative h-[100%] max-w-[90%]  ml-5 md:ml-0'>
                <div className='h-[50%] w-full '>
                <img src={G1} alt=""  className=' h-[98%] w-full object-fill object-center ' />
                </div>
              ...
              <div className='border-2 border-gray-300 relative h-[100%] max-w-[90%]  ml-5 md:ml-0'>
                ...
                <img src={G2} alt=""  className=' h-[100%] w-full object-fill object-center ' />
                </div>
                ...
                <div className='my-10 h-[50%] text-center flex flex-col gap-5 p-2'>
                  <p>Lorem Ipsum is simcscscx x x. Locsxccscscccscsrem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
